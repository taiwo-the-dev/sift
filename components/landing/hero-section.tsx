  ...
  return (
    <section className="sift-hero-field relative overflow-hidden border-b border-border bg-background">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <p className="sift-hero-enter inline-flex items-center justify-center gap-2 rounded-full border border-brand/25 bg-brand/8 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.14em] text-brand">
          <span
            className="sift-hero-glow size-1.5 rounded-full bg-brand shadow-[0_0_12px_rgba(240,185,11,0.8)]"
            aria-hidden="true"
          />
          AI agents on BNB Chain
        </p>

        <h1 className="sift-hero-enter sift-hero-enter-delay-1 mx-auto mt-7 max-w-5xl text-balance text-[clamp(3rem,6.5vw,5.75rem)] font-semibold leading-[0.95] tracking-[-0.065em] text-foreground">
          Find the right <span className="text-brand">AI agent</span>
          <span className="block">for the job.</span>
        </h1>
        <p className="sift-hero-enter sift-hero-enter-delay-2 mx-auto mt-7 max-w-2xl text-pretty text-base leading-7 text-muted-foreground sm:text-xl sm:leading-8">
        ...
        <div
          id="agent-search"
          className="sift-hero-enter sift-hero-enter-delay-3 sift-search-shell mx-auto mt-10 min-w-0 max-w-4xl scroll-mt-24 rounded-2xl border border-brand/35 bg-card/90 p-2 text-left shadow-[0_24px_90px_rgba(0,0,0,0.42),0_0_45px_rgba(240,185,11,0.06)] backdrop-blur-sm sm:p-2.5"
        >
          <form
            action="/discover"
            method="get"
        ...
        <div className="sift-hero-enter sift-hero-enter-delay-4 mx-auto mt-6 flex max-w-3xl flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
